...
class Man{
    ...
    draw(context) {
        this.images[this.image].draw(context, this.x, this.y);
    }
...
class Sprite{
    constructor(src, offset_x, offset_y) {
        this.an_image = new Image();
        this.an_image.src = src;
        this.offset_x = offset_x;
        this.offset_y = offset_y
    }
    
    draw(context, x, y) {
        var draw_x = x - this.offset_x;
        var draw_y = y - this.offset_y;
        context.drawImage(this.an_image, draw_x, draw_y);
    }
}

var sprites_man = new Array();

sprites_man[0] = new Sprite('images/man_normal.png', 25, 27);
sprites_man[1] = new Sprite('images/man_grabUp.png', 21, 31);
sprites_man[2] = new Sprite('images/man_grabRight.png', 17, 27);
sprites_man[3] = new Sprite('images/man_grabDown.png', 19, 17);
sprites_man[4] = new Sprite('images/man_grabLeft.png', 31, 27);

var MAN_X = 200;
var MAN_Y = 150;

var man = new Man(sprites_man, MAN_X, MAN_Y, 0);
...
//    }
    ...
    man.cycle();
    console.log('Image updated to ', man.image);
    man.draw(context)
...
function draw() {
    ...
    context.beginPath();
    context.moveTo(0, MAN_Y);
    context.lineTo(canvas.width, MAN_Y);
    context.moveTo(MAN_X, 0);
    context.lineTo(MAN_X, canvas.height);
    context.stroke();
}
